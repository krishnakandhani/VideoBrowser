...
import com.example.centerlayoutmanager.BuildConfig;
...
public class CenterLayoutManager extends LinearLayoutManager {
    ...
    private static final String TAG = CenterLayoutManager.class.getSimpleName();
     ...
     * Scroll state
     */
    private CenterLayoutManager.State mState;
    ...
    /**
     * Layout the item view witch position specified by {@link CenterLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == HORIZONTAL ? child.getWidth() : child.getHeight();
